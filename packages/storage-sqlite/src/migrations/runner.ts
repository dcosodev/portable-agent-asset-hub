...
export function migrate(db: DatabaseSync, dir: string): void {
  ...
  if (migrations.length !== 13 || migrations.some((migration, index) => migration.version !== index + 1)) throw new HubError('MIGRATION_GAP', 'migration sequence must be continuous 0001-0013', 500);
