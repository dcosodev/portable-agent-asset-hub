...
class GetSkillDependents200Response(BaseModel):
    """
    GetSkillDependents200Response
    """ # noqa: E501
    items: List[SkillRelation]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [SkillRelation.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
