...
class ResolveSkillGraphRequest(BaseModel):
    """
    ResolveSkillGraphRequest
    """ # noqa: E501
    skill: Annotated[str, Field(min_length=1, strict=True)]
    version: Optional[Annotated[int, Field(strict=True, ge=1)]] = None
    limits: Optional[ResolveSkillGraphRequestLimits] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["skill", "version", "limits"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limits": ResolveSkillGraphRequestLimits.from_dict(obj["limits"]) if obj.get("limits") is not None else None
        })
