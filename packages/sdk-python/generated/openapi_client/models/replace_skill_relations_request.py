...
class ReplaceSkillRelationsRequest(BaseModel):
    """
    ...
    relations: Annotated[List[ReplaceSkillRelationsRequestRelationsInner], Field(max_length=128)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["expectedVersion", "reason", "relations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relations": [ReplaceSkillRelationsRequestRelationsInner.from_dict(_item) for _item in obj["relations"]] if obj.get("relations") is not None else None
        })
